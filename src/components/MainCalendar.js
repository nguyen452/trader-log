...
import { closeModal, getCalendarModalData, selectTradeData, selectIsLoading, selectHasError } from "../slice/calendarModalSlice";
...
const MainCalendar = ({ year, month, displayProfitableDays }) => {
    ...
    const isDayProfitable = (day) => {
        ...
        console.log(dayToCheck, data.profitsPerDay)
